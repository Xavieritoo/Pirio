...
const MINERALS = [
    ...
    { id: "diamond", name: "Diamante", plural: "Diamantes", xp: 150, probability: 1.2, minAmount: 1, maxAmount: 4, rarity: "legendary", message: "💎 ¡¡¡HAS ENCONTRADO UN DIAMANTE!!!" },
    { id: "obsidian", name: "Obsidiana", plural: "Obsidianas", xp: 250, probability: 0.8, minAmount: 1, maxAmount: 3, rarity: "legendary", message: "🖤 ¡Has encontrado una extraña pieza de obsidiana!" },

    { id: "blackopal", name: "Ópalo Negro", plural: "Ópalos Negros", xp: 375, probability: 0.08, rarity: "mythic", uniqueAmount: true, message: "🌑 ¡¡¡HAS ENCONTRADO UN ÓPALO NEGRO!!! Su brillo es extraordinariamente raro." },
    ...
    { id: "paraiba", name: "Turmalina Paraíba", plural: "Turmalinas Paraíba", xp: 750, probability: 0.08, rarity: "mythic", uniqueAmount: true, message: "🩵 ¡¡¡HAS ENCONTRADO UNA TURMALINA PARAÍBA!!! Una gema de un color increíblemente raro." },
    ...
    { id: "ancient", name: "Artefacto Antiguo", plural: "Artefactos Antiguos", xp: 1200, probability: 0.08, rarity: "mythic", uniqueAmount: true, message: "🏺 ¡¡¡HAS ENCONTRADO UN ARTEFACTO ANTIGUO!!! Nadie sabe cuánto tiempo llevaba enterrado." },
    ...
    { id: "taaffeita", name: "Taaffeíta", plural: "Taaffeítas", xp: 2000, probability: 0.08, rarity: "mythic", uniqueAmount: true, message: "💜 ¡¡¡TAAFFEÍTA ENCONTRADA!!! Acabas de encontrar una de las gemas más raras y preciosas del mundo." },
    ...
    { id: "painita", name: "Painita", plural: "Painitas", xp: 5500, probability: 0.08, rarity: "mythic", uniqueAmount: true, message: "🔥 ¡¡¡HAS ENCONTRADO PAINITA!!! Una de las gemas más raras que podrías encontrar." },
    ...
    { id: "jeremejevita", name: "Jeremejevita", plural: "Jeremejevitas", xp: 9000, probability: 0.06, rarity: "mythic", uniqueAmount: true, message: "🤍 ¡¡¡JEREMEJEVITA!!! Has encontrado una gema con forma de mitad de corazón. ¿Dónde estará su otra mitad?" },
    ...
    { id: "musgravita", name: "Musgravita", plural: "Musgravitas", xp: 17500, probability: 0.07, rarity: "mythic", uniqueAmount: true, message: "🖤 ¡¡¡MUSGRAVITA!!! Has encontrado una gema con forma de mitad de corazón. ¿Quién tendrá su otra mitad?" },
    ...
    { id: "galdrabok", name: "Galdrabók", plural: "Galdrabóks", xp: 35000, probability: 0.01, rarity: "artifact", uniqueAmount: true, message: "📕 ¡¡¡HAS ENCONTRADO EL GALDRABÓK!!! Un antiguo libro de magia rúnica. Esto no debería estar aquí..." }
];
